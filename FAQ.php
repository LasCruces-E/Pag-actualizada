...
<head>
    ...
    <script src="js/js-FAQ.js" type="text/javascript"></script>
    <style type="text/css">
    .cont-si{
      visibility: hidden;
      z-index: 99;
...
<div class="d-flex justify-content-center">
    <div class="card text-center" style="width: 18rem;">
        <div class="card-body">
            ...
            <button class="btn btn-primary btn-lg bg-brown" onclick="javascript:InfoSi(event)">Si</button>
            <button class="btn btn-primary btn-lg bg-brown"onclick="javascript:InfoNo(event)">No</button>
        </div>
    </div>
</div>
<br>
<div class="card text-center shadow mx-auto" style="width: 35rem;">
        <div class="container justify-content-center cont-si" id="container-si"></div> 
        <div class="container justify-content-center cont-no" id="container-no"></div>
</div>
